...
template <class T> inline bool
Util::Monitor<T>::timedWait(const Time& timeout) const
{
    //
    // Perform any pending notifies.
    //
...
template <class T> inline void
Util::Monitor<T>::notifyImpl(int nnotify) const
{
    //
