...
#ifndef UTIL_OUTPUT_UTIL_H
#define UTIL_OUTPUT_UTIL_H
...
UTIL_API std::string int64ToString(Util::Int64);
...
class UTIL_API OutputBase : private ::Util::noncopyable
{
public:
...
class UTIL_API NextLine
{
};
extern UTIL_API NextLine nl;

class UTIL_API Separator
{
};
extern UTIL_API Separator sp;

// ----------------------------------------------------------------------
// Output
// ----------------------------------------------------------------------

class UTIL_API Output : public OutputBase
{
public:
...
class UTIL_API StartBlock
{
};
extern UTIL_API StartBlock sb;
...
class UTIL_API EndBlock
{
};
extern UTIL_API EndBlock eb;
...
class UTIL_API StartPar
{
};
extern UTIL_API StartPar spar;
...
class UTIL_API EndPar
{
};
extern UTIL_API EndPar epar;
...
UTIL_API Output& operator<<(Output&, std::ios_base& (*)(std::ios_base&));

// ----------------------------------------------------------------------
// XMLOutput
// ----------------------------------------------------------------------

class UTIL_API XMLOutput : public OutputBase
{
public:
...
class UTIL_API EndElement
{
};
extern UTIL_API EndElement ee;
...
class UTIL_API StartEscapes
{
};
extern UTIL_API StartEscapes startEscapes;

class UTIL_API EndEscapes
{
};
extern UTIL_API EndEscapes endEscapes;
...
UTIL_API XMLOutput& operator<<(XMLOutput&, std::ios_base& (*)(std::ios_base&));
