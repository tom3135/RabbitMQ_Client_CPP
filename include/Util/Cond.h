...
#if defined(_WIN32) && !defined(HAS_WIN32_CONDVAR)
#   include <Mutex.h>
...
public:
    ...
    void wait() const;
    bool timedWait(const Util::Time&) const;
...
//
class UTIL_API Cond : private noncopyable
{
public:
...
#  else
    ...
    Mutex _internal;
    UtilInternal::Semaphore _gate;
    UtilInternal::Semaphore _queue;
