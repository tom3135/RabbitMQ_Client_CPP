...
//
UTIL_API bool isAbsolutePath(const std::string&);

//
// Determine if a file exists.
//
UTIL_API bool fileExists(const std::string&);

//
// Determine if a directory exists.
//
UTIL_API bool directoryExists(const std::string&);
...
// OS stat
//
UTIL_API int stat(const std::string&, structstat*);
UTIL_API int remove(const std::string&);
UTIL_API int rename(const std::string&, const std::string&);
UTIL_API int rmdir(const std::string&);

UTIL_API int mkdir(const std::string&, int);
UTIL_API FILE* fopen(const std::string&, const std::string&);
UTIL_API int open(const std::string&, int);

#ifndef OS_WINRT
UTIL_API int getcwd(std::string&);
#endif

UTIL_API int unlink(const std::string&);
UTIL_API int close(int);
...
typedef Util::Handle<FileLock> FileLockPtr;
